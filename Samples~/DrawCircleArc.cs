        ...
        private void OnDrawGizmos()
        {
            ...
            if(_useSegCount)
            {
                if (_useLineRenderer)
                {
                    ...
                    Circle.DrawBySegCount(_lineCircle, Vector3.zero, _circleRadis, _upward, _plate, _segCount);
                }
                else
                {
                    ...
                    Circle.DrawBySegCount(Vector3.zero, _circleRadis, _upward, _plate, _segCount);
                }
            }
            else
            {
                if (_useLineRenderer)
                {
                    ...
                    Circle.Draw(_lineCircle, Vector3.zero, _circleRadis, _upward, _plate, _segAngle);
                }
                else
                {
                    _lineCircle.positionCount = 0;
                    ...
                    Circle.Draw(Vector3.zero, _circleRadis, _upward, _plate, _segAngle);
                }
            }
        }
#endif
